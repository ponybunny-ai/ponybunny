...
const SLASH_COMMANDS = [
  ...
  { cmd: '/cancel <id> [reason]', desc: 'Cancel a goal (optional reason)' },
  ...
  { cmd: '/channels', desc: 'Show channel routing and adapter health status' },
  { cmd: '/channel-events [limit] [cursor] [eventPrefix]', desc: 'Replay channel events with optional pagination/filter' },
