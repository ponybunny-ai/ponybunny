...
const KEYBOARD_SHORTCUTS = [
  ...
  { key: 'Shift+Tab', desc: 'Switch to previous view' },
  { key: '1-4', desc: 'Jump to view (Dashboard/Goals/Events/Help)' },
  { key: 'Ctrl+N', desc: 'Create new goal' },
  { key: 'Ctrl+E', desc: 'Go to Events view' },
  { key: 'Ctrl+L', desc: 'Clear events' },
