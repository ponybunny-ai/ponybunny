...
**New**: PonyBunny now supports **Model Context Protocol (MCP)** for seamless integration with external tools and services. See [MCP Documentation](../mcp/README.md) for details.

See `../techspec/architecture-overview.md` for detailed system architecture.
...
Defines Model Context Protocol server connections for external tools. See `../mcp/user-guide/integration-guide.md` for details.
...
- `../cli/` - CLI documentation and usage guides
...
- `../techspec/` - Technical specifications and architecture design
...
- `../requirement/` - Product requirements documentation
- `../engineering/` - Reference materials (OpenClaw architecture)
