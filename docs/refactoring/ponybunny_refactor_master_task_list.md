...
| RF-043 | Execution/recovery hardening | Close the minimum hardening set identified by RF-020 before broader evented adoption | planned | high | RF-020 | — | Narrow follow-up scope: daemon-safe manual replay path, explicit policy for stale/orphaned replacement replay runs, narrow replay operator auditability, and focused end-to-end workflow validation. |
